...
> **Status:** reconfigured for the Mikrotik-backbone topology 2026-07-18, in production. Uplink 1/3/2 → game-room-crs309.
...
- **Uplink:** 1/3/2 → game-room-crs309 (10G SFP+, full trunk)
...
| 1/3/2 | GameRoom-CRS309 | uplink to game-room-crs309 | no | no         | off        |
...
- IoT bridge ports are BPDU-guarded — desired behavior, don't remove.
...
- `2026-07-18-post-topology-change.txt` — `show running-config` after
  reconfiguring for the Mikrotik spine: mgmt IP → 10.1.0.15, uplink
